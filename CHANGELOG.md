...
* **Fork Initialization**: The repository was officially forked from Core Lightning to Palladium Lightning. See `README-original.md` for upstream Core Lightning details. All previous changelog entries below refer to Core Lightning.
