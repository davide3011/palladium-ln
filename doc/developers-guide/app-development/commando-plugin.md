...
Commando is a direct-to-node plugin that ships natively with Palladium Lightning. It lets you set _runes_ to create fine-grained access controls to a CLN node's RPC and provides access to those same RPCs via Lightning-native network connections. 
...
> 📘 Pro-tip
>
> - **[lnmessage](https://github.com/aaronbarnardsound/lnmessage)** allows you to talk to Palladium Lightning nodes from the browser via a Websocket connection and controls it using commando.
>
> - **[lnsocket](https://github.com/jb55/lnsocket)** allows you to build a web or mobile app that talks directly to a CLN node over commando with runes. Check out [LNLink](https://lnlink.app/) -  a mobile app that allows you to control a Palladium Lightning node over the lightning network itself!
